...
export default function Contact() {
  ...
  return (
    <section id="consultation" className="relative py-24 bg-white dark:bg-black overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-6 tracking-tight">
            Let's Engineer <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-500">Something Amazing</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="space-y-8">
              <div className="tech-card p-8 rounded-2xl border border-gray-100 dark:border-green-900/30">
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={i} className="group">
                      ...
                      <div className="flex items-center space-x-3 text-gray-900 dark:text-white font-bold group-hover:text-green-600 transition-colors">
              ...
              <div className="bg-black text-white rounded-2xl p-8 border border-green-500/20 tech-glow relative overflow-hidden">
                <div className="absolute top-0 right-0 p-4 font-mono text-[40px] font-bold opacity-10 pointer-events-none">
                  SLA
                </div>
                <h4 className="font-mono text-xs font-bold text-green-400 mb-4 uppercase tracking-widest">Protocol.Response</h4>
            ...
            <form onSubmit={handleSubmit} className="tech-card rounded-2xl p-8 md:p-10 space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-4 rounded-sm bg-gray-50 dark:bg-black border border-gray-200 dark:border-green-500/30 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-transparent transition-all font-medium"
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-4 rounded-sm bg-gray-50 dark:bg-black border border-gray-200 dark:border-green-500/30 text-gray-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-transparent transition-all font-medium appearance-none"
                  >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-4 rounded-sm bg-gray-50 dark:bg-black border border-gray-200 dark:border-green-500/30 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-transparent transition-all font-medium resize-none"
              ...
              <button
                ...
                className="w-full bg-gray-900 dark:bg-green-600 text-white dark:text-white font-bold py-5 px-8 rounded-sm transition-all duration-200 hover:bg-green-600 dark:hover:bg-green-500 hover:text-white dark:hover:text-white flex items-center justify-center space-x-3 shadow-xl tech-glow disabled:cursor-not-allowed uppercase tracking-widest text-sm"
              >
