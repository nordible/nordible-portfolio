              ...
              <section className="bg-nordible-section-bg dark:bg-gray-800/50 p-8 rounded-3xl border border-nordible-border dark:border-gray-700">
                ...
                <div className="grid sm:grid-cols-2 gap-8">
                   ...
                   <div className="sm:col-span-2 flex items-start space-x-4">
                      ...
                      <span className="text-sm font-bold text-gray-600 dark:text-gray-300 uppercase tracking-widest leading-relaxed">002, Simply Move In, 17 Maruthi Layout, AECS Layout, Bangalore 560037</span>
                   </div>
                </div>
              </section>
            </div>
